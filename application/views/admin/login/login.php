...
<body class="hold-transition login-page" style="background-image: url('<?php echo base_url("uploads/developer/").$this->loginback;?>');background-repeat:no-repeat;background-size: cover;background-position: center;height: 100vh;">
  ...
  <div class="container gap">
    <div class="col-md-offset-4 col-sm-offset-4  col-sm-4 col-md-4 white">
      ...
      <div align="center" data-tilt>
        ...
        <img style="width: 200px;" src="<?php echo base_url("uploads/settings/").$this->header_logo;?>" alt="IMG">
        <!--img src="<?php echo base_url('assets/admin/assets/');?>images/img-01.png" alt="IMG" -->
      </div>
