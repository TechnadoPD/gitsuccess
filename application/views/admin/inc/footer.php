...
<script>
  $(document).ready(function(){
    function imagePrepend(imgName){
     var image_html = '<div class="col-sm-2 setting"> <div class="asd"> <button class="selectimage" data-path="<?php echo base_url()."uploads"."/".str_replace("-","_",$this->uri->segment(2)); ?>/'+imgName+'" data-image="'+imgName+'" type="button">Select</button> <button class="deletephoto" data-id=""<?php echo "uploads"."/".str_replace("-","_",$this->uri->segment(2)); ?>/'+imgName+'"" type="button">Delete</button> <img for="asd" src="<?php echo base_url()."uploads"."/".str_replace("-","_",$this->uri->segment(2)); ?>/'+imgName+'" class="img-responsive imgsetting"> </div> </div>';
   ...
   var identifier;
        ...
        $("body").on("click",".selectimage",function(){
         ...
         $(".deletephoto").on("click",function(){
          ...
          $.ajax({
            url:"<?php echo base_url("admin/settings/photo_delete");?>",
            method:"post",
            dataType:"json",
         ...
         $("#selectedimage").on("change",function(){
          ...
          $.ajax({
            url:"<?php echo base_url("admin/settings/photo_upload");?>",
            method:"post",
            dataType:"json",
            cache: false,
            contentType: false,
