...
<head>
	<meta charset="utf-8" />
	<link rel="icon" type="image/png" href="<?php echo base_url('uploads/settings/').$this->fav_icon;?>">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
	<title><?php echo ucwords(str_replace(str_split('-_'),'&nbsp;', $this->uri->segment(3)? $this->uri->segment(3):$this->uri->segment(2)));; ?></title>
...
<body style="background-image: url('<?php echo base_url('uploads/developer/').$this->contentimage;?>');background-size:cover;">
            ...
            <div class="form-group">
                ...
                <div class="input-group-btn">
                 <div class="image-upload">                      
                  ...
                  <div class="file-btn">
                    <form id="imageupload" action="<?php echo base_url("admin/settings/photo_upload");?>">
