      ...
      <form role="form" action="<?php echo base_url('admin/testimonials/add');?>" method="post" enctype="multipart/form-data">       
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <textarea class="editor form-control" rows="3" id="testimonials_text" name="testimonials_text" required><?php echo !empty($record->testimonials_text)?$record->services_details_text:''?></textarea>
