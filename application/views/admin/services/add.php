<div class="content">
  <div class="container-fluid">
    ...
    <div class="col-md-6">
      <form role="form" action="<?php echo base_url('admin/services/add')?>" method="post" enctype="multipart/form-data">       
        <div class="box-body">

          <div class="form-group">
            <label>Services <span style="color:red;">Heading</span> </label>
            <input type="name" class="form-control" id="services_heading" name="services_heading" required>
